...
## Project Overview
This capstone project is targeting to provide fun experience to
users.
When the user uploads his/her photo, through a web/mobile app,
...
Along with exploring state-of-the-art CNN models for classification,  important design decisions about the user experience for the app are made. Each model has its strengths and weaknesses, and engineering a real-world application often involves solving many problems without a perfect answer.  Your imperfect solution will nonetheless create a fun user experience!
...
```	
git clone https://github.com/SadhanaPaladugu/DogProject.git
cd dog-project
```
